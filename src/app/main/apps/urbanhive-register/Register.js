...
function Register() {
  ...
  //if (isAuth) return <Redirect to={'/apps/sessions'}/>
  return (
    <div
      className={clsx(
        classes.root,
          ...
          <CardContent className="flex flex-col items-center justify-center w-full py-96 max-w-320">
            ...
            >
              <div className="flex items-center justif-center mb-32">
                <img className="logo-icon mr-4 w-48" src="assets/images/logos/bridgetech_s.png" alt="logo" />
          ...
          <div className="max-w-320">
            ...
            >
              <Typography variant="h3" color="inherit" className="font-semibold leading-tight">
                Welcome <br />
                to <br /> 
               <div style={{width:"max-content"}}> CMC NETWORK!</div>
              </Typography>
            </motion.div>
