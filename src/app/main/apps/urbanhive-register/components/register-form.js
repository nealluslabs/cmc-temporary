...
<FormControl>
      <FormLabel  style={{fontSize:"1.4rem"}} id="demo-row-radio-buttons-group-label">Registration Type</FormLabel>
      <RadioGroup
        row 
      ...
      >
        <FormControlLabel value="Contractor"  style={{scale:"1.4", marginRight:"6rem"}} control={<Radio />} label="Contractor" checked={contractorChecked} onClick={chooseContractor}/>
        <FormControlLabel value="Advisor"  style={{scale:"1.4"}} control={<Radio />} label="Trusted Advisor" checked={advisorChecked} onClick={chooseAdvisor}/>
