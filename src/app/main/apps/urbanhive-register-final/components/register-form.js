...
<FormControl>
      ...
      <FormLabel  style={{ fontSize:"1.4rem"}} id="demo-row-radio-buttons-group-label">Are you a certified MBE/WBE?</FormLabel>
      <RadioGroup
        row
        aria-labelledby="demo-row-radio-buttons-group-label"
        name="row-radio-buttons-group"
      >
        <FormControlLabel  style={{scale:"1.4", marginRight:"6rem"}} value={true} control={<Radio />} label="Yes" checked={contractorChecked} onClick={chooseContractor}/>
        <FormControlLabel  style={{scale:"1.4"}} value={false} control={<Radio />} label="No" checked={advisorChecked} onClick={chooseAdvisor}/>
