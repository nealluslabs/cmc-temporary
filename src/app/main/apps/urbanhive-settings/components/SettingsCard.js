...
import DEFAULTIMG from '../../images/rec.png';
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
//import { notifyErrorFxn } from 'src/utils/toast-fxn';
import { updateProfile, uploadImage, uploadProfileImage } from '../../../../../redux/actions/auth.action';
  ...
  const classes = useStyles();
    ...
    //   return;
      ...
      if(selectedFile.selectedFile.length == 0){
        ...
        dispatch(updateProfile(state, id, '', history, setLoading, imageUrl));
      }else{
        dispatch(uploadProfileImage(state, selectedFile.selectedFile, id, history, setLoading));
      }
